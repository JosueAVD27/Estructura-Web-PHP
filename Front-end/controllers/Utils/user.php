...
switch ($_GET[CONTROLADOR_TABLA]) {
    ...
    case "mostrar_informacion_usuario":
        ...
        if (is_array($datos) == true and count($datos) <> 0) {
            foreach ($datos as $row) {
                ...
                $output["apellidoPaterno_usuario"] = $row["apellidoPaterno_usuario"];
                $output["apellidoMaterno_usuario"] = $row["apellidoMaterno_usuario"];
    ...
    case "actualizar_perfil":
        ...
        $datos = $usuario->update_perfil(
            ...
            $_POST["apellidoPaterno_usuario"],
            $_POST["apellidoMaterno_usuario"],
            $_POST["id_pais"],
            $_POST["dni_usuario"],
    ...
    // Verificar y actualizar la contraseña del usuario
...
function informacionTabla($offset, $datos, $totalResultados, $resultadosPorPagina)
{
    ...
    foreach ($datos as $row) {
        ...
        <tr>
            <td>' . $contador++ . '</td>
            <td>' . $row["nombre_usuario"] . " " . $row["apellidoPaterno_usuario"] . '</td>
