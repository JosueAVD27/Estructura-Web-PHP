<svg display="none">
    ...
    <symbol id="download" viewBox="0 0 32 32">
        <circle r="15" cx="16" cy="16" fill="none" stroke="hsl(200,90%,55%)" stroke-width="2" />
        <polyline points="11,16 16,21 21,16" fill="none" stroke="hsl(200,90%,55%)" stroke-width="2"
            stroke-linecap="round" stroke-linejoin="round" />
        <line x1="16" y1="10" x2="16" y2="20" stroke="hsl(200,90%,55%)" stroke-width="2" stroke-linecap="round" />
        <line x1="10" y1="24" x2="22" y2="24" stroke="hsl(200,90%,55%)" stroke-width="2" stroke-linecap="round" />
    </symbol>
    <symbol id="edit" viewBox="0 0 32 32">
        <circle r="15" cx="16" cy="16" fill="none" stroke="hsl(53,90%,55%)" stroke-width="2" />
        <g transform="translate(6.5,5.5) scale(.8)">
            <path
                ...
                fill="hsl(50,90%,55%)" stroke-width="0" />
            <path
                ...
                fill="hsl(53,90%,55%)" stroke-width="0" />
        </g>
    </symbol>
    <symbol id="adduser" viewBox="0 0 32 32">
        <circle r="15" cx="16" cy="16" fill="none" stroke="hsl(153,90%,55%)" stroke-width="2" />
        <g transform="translate(6.5,5.5) scale(.4)">
        ...
        C1.3,45.1,3.9,49,8,49h17c0.8,0,1.3-1,0.8-1.6C23.3,44.5,21.9,40.8,21.9,37z" fill="hsl(153,90%,55%)"
                stroke-width="0" />
        ...
        c0.6,0,1.1,0.4,1.1,1v3h2.9c0.6,0,1.1,0.4,1.1,1V38z" fill="hsl(153,90%,55%)" stroke-width="0" />
        </g>
    </symbol>
    <symbol id="password" viewBox="0 0 32 32">
        <circle r="15" cx="16" cy="16" fill="none" stroke="hsl(23,90%,55%)" stroke-width="2" />
        <path transform="translate(6.5,6.5) scale(.8)"
            ...
            fill="hsl(23,90%,55%)" stroke-width="0"></path>
    </symbol>
</svg>