...
function cargar_informacion() {
    $.post("controllers/Utils/user.php?st=mostrar_informacion_usuario", { id_usuario: G_id_usuario })
        .then(function (data) {
...
$(document).on("click", "#btnactualizar", function () {
    ...
    $.post("controllers/Utils/user.php?st=mostrar_informacion_usuario", { id_usuario: G_id_usuario }, function (data) {
        data = JSON.parse(data);
...
function actualizar_datos(dataObject) {
    $.post("controllers/Utils/user.php?st=actualizar_perfil", dataObject)
        .done(function (data) {
            data = JSON.parse(data);
...
function seleccionar_actualizacion(imageFile) {
    var dataObject = {
        ...
        apellidoPaterno_usuario: $('#apellidoPaterno_usuario').val(),
        apellidoMaterno_usuario: $('#apellidoMaterno_usuario').val(),
        id_pais: $('#id_pais').val(),
...
function eliminar_foto(dataObject) {
    $.post("controllers/Utils/user.php?st=eliminar_foto", dataObject, function (data) {
        data = JSON.parse(data);
        if (data.status === "success") {
